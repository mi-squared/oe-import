...
(function( $ ){
  $.fn.printPage = function(options) {
     ...
     */
    function printit(pluginOptions){

      var selector = 'printPage';
    ...
    var components = {
      iframe: function(){
          return '<iframe id="printPage" name="printPage" style="position: absolute; top: -1000px; @media print { display: block; }"></iframe>';
